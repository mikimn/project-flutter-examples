...
class PokemonServices {
  static Stream<Pokemon> get pokemons async* {
    for (var i = 1; i < 50; i++) {
      ...
      try {
        ...
        if (response.statusCode != 200) {
          developer.log(
              'Access to pokemon API returned error.',
              name: 'pokemonServices.pokemons',
        ...
        yield Pokemon.fromJson(jsonPokemon);
          ...
          developer.log(
            'Exception during access to pokemon API.',
            level: 0,
            name: 'pokemonServices.pokemons',
            error: e
          );
